    ...
    <body>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-right:10px;' width='80' height='13' align='right' valign='middle'>Bs. $precio_compra</td>
                        <td style='padding-right:10px;' width='80' height='13' align='right' valign='middle'>Bs. $precio_venta</td>
